...
* Replace the **logo, profile photo, and background images** in the `assets/` folder
* Update the **About**, **Skills**, and **Projects** sections in `index.html`
* Tweak `style.css` to match your personal theme/colors
...
* GitHub: \[[github.com/AviralJaiswal](https://github.com/AviralJaiswal)]
